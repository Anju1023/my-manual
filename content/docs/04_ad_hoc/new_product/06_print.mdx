...
# <Printer className='inline w-[1em] h-[1em] mr-1 -mt-1' /> 数量入力と印刷
...
## <ClipboardList className='inline w-[1em] h-[1em] mr-1 -mt-1' /> 手順 1: 依頼ファイルの作成
...
## <ClipboardList className='inline w-[1em] h-[1em] mr-1 -mt-1' /> 手順 2: データの取り込み
...
## <ListChecks className='inline w-[1em] h-[1em] mr-1 -mt-1' /> 次のステップ
